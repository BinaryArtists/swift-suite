...
class UserListViewController: UIViewController, UserListViewControllerInput {
    ...
    func requestGetUser() { // self -> interactor
    ...
    func displayUser(viewModel: UserListScene.GetUser.ViewModel) { // presenter -> self
    ...
    func addUserButtonClicked(_ sender: UIBarButtonItem) {
        requestGetUser()
    }
