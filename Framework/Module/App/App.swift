...
public enum _App {
    ...
    internal static let AppHasBeenOpened = "AppHasBeenOpened"
    ...
    ///
    /// - Parameter version: Version to be checked, you can use the variable `App.version` to pass the current App version.
    ...
    ///
    /// - Parameters:
    ///   - version: Version to be checked, you can use the variable `App.version` to pass the current App version.
    ...
    public static func setAppSetting(object: Any, forKey objectKey: String) -> Bool {
        return FileManager.default.setSettings(filename: _App.name, object: object, forKey: objectKey)
    }
    ...
    public static func getAppSetting(objectKey: String) -> Any? {
        return FileManager.default.getSettings(filename: _App.name, forKey: objectKey)
    }
...
/// Extends _App with project infos.
public extension _App {
    // MARK: - Variables
    
    /// Return the App name.
    static var name: String = {
        return _App.stringFromInfoDictionary(forKey: "CFBundleDisplayName")
    }()
    
    /// Returns the App version.
    static var version: String = {
        return _App.stringFromInfoDictionary(forKey: "CFBundleShortVersionString")
    }()
    
    /// Returns the App build.
    static var build: String = {
        return _App.stringFromInfoDictionary(forKey: "CFBundleVersion")
    }()
    
    /// Returns the App executable.
    static var executable: String = {
        return _App.stringFromInfoDictionary(forKey: "CFBundleExecutable")
    }()
    
    /// Returns the App bundle.
    static var bundle: String = {
        return _App.stringFromInfoDictionary(forKey: "CFBundleIdentifier")
    }()
