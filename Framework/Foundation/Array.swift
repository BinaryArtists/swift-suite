...
import Foundation
import QuartzCore
//# https://www.cnblogs.com/wj033/p/4213737.html
...
public extension Array {
    ...
    func superCircle(at index: Int, size maxSize: Int) -> Int {
        var _index = index
        if _index < 0 {
...
public extension Array {
    ...
    */
    func contains <T: Equatable> (items: T...) -> Bool {
        return items.all(test: { self.indexOf(item: $0) ?? default value >= 0 })
    }
    ...
    */
    @available(*, unavailable, message: "use the 'first' property instead")
    func first () -> Element? {
        return first
    }
    ...
    */
    @available(*, unavailable, message: "use the 'last' property instead")
    func last () -> Element? {
        return last
    }
    ...
    */
    func partition ( n: Int, var step: Int? = nil) -> [Array] {
        var result = [Array]()
