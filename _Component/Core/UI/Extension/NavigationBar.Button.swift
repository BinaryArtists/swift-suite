...
extension UIViewController {
    ...
    func setLeftNavigationBarButton(title: String, target: Any?, action: Selector?) {
        let barButtonItem = UIBarButtonItem(title: title, style: UIBarButtonItemStyle.plain, target: self, action: action)
    ...
    func setLeftNavigationBarButton(imageName: String, target: Any?, action: Selector?) {
        ...
        let barButtonItem = UIBarButtonItem(image: image, style: UIBarButtonItemStyle.plain, target: self, action: action)
        self.navigationItem.leftBarButtonItem = barButtonItem;
    }
     ...
     */
    func setLeftNavigationBarButton(systemItem: UIBarButtonSystemItem, target: Any?, action: Selector?) {
     ...
     */
    func setRightNavigationBarButton(systemItem: UIBarButtonSystemItem, target: Any?, action: Selector?) {
        let barButtonItem = UIBarButtonItem(barButtonSystemItem: systemItem, target: target, action: action)
        self.navigationItem.rightBarButtonItem = barButtonItem;
    }
